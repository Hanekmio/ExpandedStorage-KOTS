...
public final class Utils {
    ...
    public static final ResourceLocation PAGINATED_SCREEN_TYPE = ResourceLocation.fromNamespaceAndPath(Utils.MOD_ID, "paginated");
    public static final ResourceLocation SINGLE_SCREEN_TYPE = ResourceLocation.fromNamespaceAndPath(Utils.MOD_ID, "single");
    public static final ResourceLocation SCROLLABLE_SCREEN_TYPE = ResourceLocation.fromNamespaceAndPath(Utils.MOD_ID, "scrollable");
    public static final ResourceLocation MINI_STORAGE_SCREEN_TYPE = ResourceLocation.fromNamespaceAndPath(Utils.MOD_ID, "mini_storage");
