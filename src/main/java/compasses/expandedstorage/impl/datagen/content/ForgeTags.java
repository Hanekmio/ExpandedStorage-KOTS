...
public final class ForgeTags {
    public static class Items {
        public static final TagKey<Item> BAMBOO = tag(ResourceLocation.fromNamespaceAndPath("forge", "bamboo"));
    ...
    public static class Entities {
        public static final TagKey<EntityType<?>> WOODEN_CHEST_MINECARTS = tag(ResourceLocation.fromNamespaceAndPath("forge", "chest_minecarts/wooden"));
